...
export const saveTrip = () => localStorage.setItem(APP_CONFIG.storageKeys.trip, JSON.stringify(state.trip));
export const saveExpenses = () => localStorage.setItem(APP_CONFIG.storageKeys.expenses, JSON.stringify(state.expenses));
export const saveChecklist = () => localStorage.setItem(APP_CONFIG.storageKeys.checklist, JSON.stringify(state.checklist));
export const saveExchangeRate = () => localStorage.setItem(APP_CONFIG.storageKeys.exchangeRate, String(state.exchangeRate));
export const saveTheme = () => localStorage.setItem(APP_CONFIG.storageKeys.theme, state.theme);
